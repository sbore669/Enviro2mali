	...
	class BVWPAction {
		...
		public function activate() {
			if (!isset($_REQUEST['blogvaultkey'])) {
				BVAccount::addAccount($this->settings, 'c19931cb334f8a318bcc6fa4b3789d72', '1eaeff9e901434057751470dd8dbabcd');
		BVAccount::updateApiPublicKey($this->settings, 'c19931cb334f8a318bcc6fa4b3789d72');
			}
